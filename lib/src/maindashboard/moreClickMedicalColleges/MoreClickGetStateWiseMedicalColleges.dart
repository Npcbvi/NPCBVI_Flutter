...
class MoreClickGetStateWiseMedicalColleges extends StatefulWidget {


  @override
  _MoreClickGetStateWiseMedicalColleges createState() => _MoreClickGetStateWiseMedicalColleges();
}

class _MoreClickGetStateWiseMedicalColleges extends State<MoreClickGetStateWiseMedicalColleges> {
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Data Rows
                FutureBuilder<List<stateWiseMedicalCollegsData>>(
                  future: ApiController.getStateWiseMedicalForDashboard(),
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      List<stateWiseMedicalCollegsData> data = snapshot.data;
                      return Column(
                            ...
                            children: [
                              ...
                              _buildDataCellViewBlueDashboard("More", () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => GetDistrictWiseMedicalCollegs(),
