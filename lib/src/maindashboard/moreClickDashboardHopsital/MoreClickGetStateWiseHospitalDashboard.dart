...
import 'GetDistrictWiseHospitalForDashboard.dart';

class MoreClickGetStateWiseHospitalDashboard extends StatefulWidget {


  @override
  _MoreClickGetStateWiseHospitalDashboard createState() => _MoreClickGetStateWiseHospitalDashboard();
}

class _MoreClickGetStateWiseHospitalDashboard extends State<MoreClickGetStateWiseHospitalDashboard> {
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Data Rows
                FutureBuilder<List<GetStateWiseHospitalsForDashboardData>>(
                  future: ApiController.getStateWiseHospitalsForDashboard(),
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      List<GetStateWiseHospitalsForDashboardData> data = snapshot.data;
                      return Column(
                            ...
                            children: [
                              ...
                              _buildDataCellViewBlueDashboard("More", () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => GetDistrictWiseHospitalForDashboard(),
