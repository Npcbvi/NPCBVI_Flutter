...
class GetDistrictWiseHospitalForDashboard extends StatefulWidget {
  @override
  _GetDistrictWiseHospitalForDashboard createState() =>
      _GetDistrictWiseHospitalForDashboard();
}

class _GetDistrictWiseHospitalForDashboard
    extends State<GetDistrictWiseHospitalForDashboard> {
  String moreclickHospitalStatedCodess;
  int moreclickHospitalStatedCodesss;
  ...
  Future<void> fetchMoreclickNgoStateCode() async {
    try {
      ...
      if (moreclickHospitalStatedCodess != null) {
        ...
        if (moreclickHospitalStatedCodesss == null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: moreclickHospitalStatedCodesss == null
          ? const Center(
        child: Text(
          "No state code found.",
          ...
          : FutureBuilder<List<GeDistrictWiseHospitalsForDashboardData>>(
        future: ApiController.getDistrictWiseHospitalForDashboard(
          moreclickHospitalStatedCodesss,
        ),
                    ...
                    return Row(
                      children: [
                        ...
                        _buildDataCellViewBlueDashboard("More", () {
                          SharedPrefs.storeSharedValues(AppConstant.moreclickdistrictCodeHospital,
                              entry.districtCode.toString());
                          SharedPrefs.storeSharedValues(AppConstant.moreclickHospitalStateCode,
                              entry.stateCode.toString());
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BothStateDistrictwiseHospital(),
