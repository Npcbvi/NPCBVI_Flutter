...
class _ScreeningCenterUpComings extends State<ScreeningCenterUpComings> {
        ...
        child: Column(
          ...
          _buildHeaderCell('Email Id'), */
                  ...
                  FutureBuilder<List<ScreeningCampCompletedListData>>(
                     future: ApiController.getSPOScreeningCampApproval_listUpComing( district_code_login,
                         state_code_login,
                         "Comming",
