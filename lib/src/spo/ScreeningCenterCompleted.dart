...
class ScreeningCenterCompleted extends StatefulWidget {
  final String districtName;
  final int districtCode;

  // Constructor to accept districtName
  ScreeningCenterCompleted({Key key,  this.districtName, this.districtCode}) : super(key: key);
  @override
  _ScreeningCenterCompleted createState() => _ScreeningCenterCompleted();
}

class _ScreeningCenterCompleted extends State<ScreeningCenterCompleted> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Screening Camp(s) (Completed)' ,maxLines: 2, // Limits text to 2 lines
        ...
        child: Column(
          children: [
            ...
            FutureBuilder<List<ScreeningCampCompletedListData>>(
              future: ApiController.getSPOScreeningCampApproval_list(
                widget.districtCode,
                state_code_login,
                "Completed",
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<ScreeningCampCompletedListData> ddata = snapshot.data;
                  print('@@---ScreeningCampCompletedListData Count: ${ddata.length}');
  ...
  void _showDetailsDialogprivatePractioneries(BuildContext context, ScreeningCampCompletedListData offer) {
    showDialog(
      context: context,
          ...
          content: SingleChildScrollView(
            ...
            child: Table(
              ...
              children: [
                ...
                _buildTableRow('Camp', offer.campName),
                _buildTableRow('Camp Manager', offer.campmanagername),
                _buildTableRow('Address', offer.address),
                _buildTableRow('Start Date',Utils.formatDateString(offer.startDate)),
                _buildTableRow('End Date', Utils.formatDateString(offer.endDate)),
