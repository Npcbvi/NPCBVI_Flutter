...
import 'package:mohfw_npcbvi/src/spo/SatelliteCentresList.dart';
import 'package:mohfw_npcbvi/src/spo/ScreeningCenterCompleted.dart';
import 'package:mohfw_npcbvi/src/spo/ScreeningCenterUpComings.dart';
...
import 'ScreeningCenterOngoing.dart';
...
class _SpoDashboard extends State<SpoDashboard> {
 ...
 bool SPO_ScreeningCampOngoing=false;
 bool SPO_SatelliteCentres=false;

  bool SPO_ScreeningCampUpComing=false;
  @override
  void initState() {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SPO_ScreeningCampOnGoing(),
            SPO_ScreeningCampUpComings(),
            SPO_SatelliteCentre(),
...
// New method to build the radio button cell
  ...
  Widget _buildHeaderCellDashboardDistrictForPatientFince(String text) {
    double screenWidth = MediaQuery.of(context).size.width;
  ...
  Widget _buildDataCellDistrictForPatientFince(String text) {
    double screenWidth = MediaQuery.of(context).size.width;
...
// Helper method to build table cells
                          ...
                          children: ddata.map((offer) {
                            return Row(
                              ...
                              children: [
                                _buildDataCellSrNoDashboards(
                                    (ddata.indexOf(offer) + 1).toString()),
                                _buildDataCellDistrictForPatientFince(offer.districtName),
                                _buildDataCellDashboardTotal(
                                    offer.totalCount.toString()),
                                _buildDataCellViewBlueDashboard("View", () {
                                  print('@@district_code for item: ${offer.districtCode}');
                                  showDiseaseApprovedPatintViewClick(offer.districtCode);
  ...
  void showDiseaseApprovedPatintViewClick(int district_code_spo ) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        // Get screen size
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            _buildHeaderCellSrNoDashboard('S.No.'),
                            _buildHeaderCellDashboardDistrictForPatientFince('Disease '),
                            _buildHeaderCellDashboardsTotal('Total'),
                            _buildHeaderCellDashboardsAction('Action'),
                          ],
                        ),
                        ...
                        FutureBuilder<
                          ...
                          future:
                            ...
                            diseaseid,*/
                            // 568, 33, "2024-2025", statusApproved,
                                district_code_spo, state_code_login,
                            currentFinancialYear, statusApproved,
                          ),
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                                  ...
                                  return Row(
                                    ...
                                    children: [
                                      _buildDataCellSrNoDashboards(
                                          (ddata.indexOf(offer) + 1)
                                              .toString()),
                                      _buildDataCellDistrictForPatientFince(offer.diseaseName),
                                      _buildDataCellDashboardTotal(
                                      ...
                                      _buildDataCellViewBlueDashboard("View", () {
                                        ...
                                        showDiseaseGetSPO_Patients_Approved_View(
                                            offer.districtCode,offer.diseaseId);
                                      }),
                                    ],
                                  );
                                }).toList(),
  ...
  void showDiseasePendingPatintViewClick(int districtCodeSPo) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        // Get screen size
                        ...
                        FutureBuilder<
                          ...
                          future:
                            ...
                            // 568, 33, "2024-2025", statusPending, in case of pending
                                districtCodeSPo, state_code_login,
  ...
  void showDiseaseGetSPO_Patients_Approved_View(int districtCodeSPO,int diseaseId) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        double screenWidth = MediaQuery.of(context).size.width;
        ...
        return AlertDialog(
          ...
          content: Container(
            ...
            height: screenHeight * 0.7,
            child: FutureBuilder<List<GetSPO_Patients_Approved_ViewData>>(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            _buildHeaderCellSrNoDashboard('S.No'),
                            _buildHeaderCellDashboardDistrictForPatientFince('NGO'),
                            _buildHeaderCellDashboardsTotal('Total'),
                            _buildHeaderCellDashboardsAction('Action'),
                          ],
                        ),
                        ...
                        ...ddata.map((offer) {
                          return Row(
                            ...
                            children: [
                              ...
                              _buildDataCellDistrictForPatientFince(offer.ngoname),
                              _buildDataCellDashboardTotal(offer.total.toString()),
                              _buildDataCellViewBlueDashboard("View", () {
  ...
  void showDiseaseGetSPO_Patients_Pending_View(int districtcodeSPO,int diseaseId) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        // Get screen size
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            _buildHeaderCellSrNoDashboard('S.No.'),
                            _buildHeaderCellDashboardDistrictForPatientFince('District Name'),
                            _buildHeaderCellDashboardsTotal('Total'),
                            _buildHeaderCellDashboardsAction('Action'),
                          ],
                        ),
                                    ...
                                    children: [
                                      ...
                                      _buildDataCellViewBlueDashboard("View", () {
                                        print(
                                            '@@Edit clicked for item: ${offer.districtName}');
                                        // You can add further actions here if needed
                                        showDiseasePendingPatintViewClick(offer.districtCode);
                                      }),
                                    ],
                                  );
                                }).toList(),
...
//here click of NGO(s) approved
  ...
  Widget SPO_ScreeningCampOnGoing() {
    return Column(
      children: [
        Visibility(
          visible: SPO_ScreeningCampOngoing,
          child: Column(
            children: [
              // Horizontal Scrolling Header Row
              Container(
              ...
              FutureBuilder<List<ScreeningCampCompltedData>>(
                /*   future: ApiController.getSPO_ScreeningCampApproval(
                    ...
                    "2019-2020",
                    ""),*/
                future: ApiController.getSPO_ScreeningCampApprovalOnGoing(
                    district_code_login,
                    state_code_login,
                    "Ongoing",
                    currentFinancialYear,
  ...
  Widget SPO_ScreeningCampUpComings() {
    return Column(
      children: [
        Visibility(
          visible: SPO_ScreeningCampUpComing,
          child: Column(
            children: [
              // Horizontal Scrolling Header Row
  ...
  Widget SPO_SatelliteCentre() {
    return Column(
      children: [
        Visibility(
          visible: SPO_SatelliteCentres,
          child: Column(
            children: [
              // Horizontal Scrolling Header Row
              Container(
