...
class ListPrivatePractionriesApproval extends StatefulWidget {
  ...
  ListPrivatePractionriesApproval({Key key,  this.districtName, this.districtCode}) : super(key: key);
  @override
...
class _ListPrivatePractionriesApproval extends State<ListPrivatePractionriesApproval> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Private Practitioner(s) (Approval)' ,maxLines: 2, // Limits text to 2 lines
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'Private Practitioners (Approved)', // Added spacing between words
                      maxLines: 2,
