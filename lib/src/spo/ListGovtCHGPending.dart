...
class _ListGovtCHGPending extends State<ListGovtCHGPending> {
        ...
        child: Column(
          ...
          _buildHeaderCell('Email Id'), */
                  ...
                  FutureBuilder<List<GHC_approvalListData>>(
                    future: ApiController.getSPO_GHCHCOtherApproval_list(district_code_login, state_code_login,currentFinancialYear , 1),
