...
// unused url
  ...
  static String getCampDashboardData = 'Camp/api/GetCampDashboardData';
  ...
  static String GetData_amount_totalCountCongenitalPtosisPatients = 'DpmDashboard/api/GetData_amount_totalCountCongenitalPtosisPatients';
  static String GetDPM_CongenitalReport = 'DpmDashboard/api/GetDPM_CongenitalReport';
  ...
  static String GetDPM_RetinoblasmaDataApprove= 'DpmDashboard/api/GetDPM_RetinoblasmaDataApprove';

  static String GetDPM_TraumaChildrenDataApprove= 'DpmDashboard/api/GetDPM_TraumaChildrenDataApprove';
