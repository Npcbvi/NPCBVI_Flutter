class CornealBlindnessPdfFile {
  String message;
  bool status;
  List<CornealBlindnessPdfFileData> data;
  dynamic list;

  CornealBlindnessPdfFile({this.message, this.status, this.data, this.list});

  CornealBlindnessPdfFile.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <CornealBlindnessPdfFileData>[];
      json['data'].forEach((v) {
        data.add(new CornealBlindnessPdfFileData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class CornealBlindnessPdfFileData {
  int srNo;
  String campId;
  String pUniqueID;
  String name;
  ...
  CornealBlindnessPdfFileData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
