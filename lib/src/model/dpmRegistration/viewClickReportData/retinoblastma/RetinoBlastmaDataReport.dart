class RetinoBlastmaDataReport {
  String message;
  bool status;
  List<RetinoBlastmaDataReportData> data;
  dynamic list;

  RetinoBlastmaDataReport({this.message, this.status, this.data, this.list});

  RetinoBlastmaDataReport.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <RetinoBlastmaDataReportData>[];
      json['data'].forEach((v) {
        data.add(new RetinoBlastmaDataReportData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class RetinoBlastmaDataReportData {
  int id;
  String pUniqueID;
  String name;
  String addressLine1;
  ...
  RetinoBlastmaDataReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
