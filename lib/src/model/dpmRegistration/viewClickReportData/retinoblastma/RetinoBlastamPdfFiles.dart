class RetinoBlastamPdfFiles {
  String message;
  bool status;
  List<RetinoBlastamPdfFilesData> data;
  dynamic list;

  RetinoBlastamPdfFiles({this.message, this.status, this.data, this.list});

  RetinoBlastamPdfFiles.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <RetinoBlastamPdfFilesData>[];
      json['data'].forEach((v) {
        data.add(new RetinoBlastamPdfFilesData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class RetinoBlastamPdfFilesData {
  int srNo;
  String campId;
  String pUniqueID;
  String name;
  ...
  RetinoBlastamPdfFilesData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
