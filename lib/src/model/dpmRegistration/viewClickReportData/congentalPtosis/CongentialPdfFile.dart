class CongentialPdfFile {
  String message;
  bool status;
  List<CongentialPdfFileData> data;
  dynamic list;

  CongentialPdfFile({this.message, this.status, this.data, this.list});

  CongentialPdfFile.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <CongentialPdfFileData>[];
      json['data'].forEach((v) {
        data.add(new CongentialPdfFileData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class CongentialPdfFileData {
  ...
  CongentialPdfFileData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
