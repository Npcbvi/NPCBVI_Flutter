class CongentialPtosisDataReport {
  String message;
  bool status;
  List<CongentialPtosisDataReportData> data;
  dynamic list;

  CongentialPtosisDataReport({this.message, this.status, this.data, this.list});

  CongentialPtosisDataReport.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <CongentialPtosisDataReportData>[];
      json['data'].forEach((v) {
        data.add(new CongentialPtosisDataReportData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class CongentialPtosisDataReportData {
  int id;
  String pUniqueID;
  String name;
  String addressLine1;
  ...
  CongentialPtosisDataReportData(
      {this.id,
        this.pUniqueID,
        this.name,
        this.addressLine1,
  ...
  CongentialPtosisDataReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
