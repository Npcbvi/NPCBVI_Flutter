class TauminchildrenPdfFiles {
  String message;
  bool status;
  List<TauminchildrenPdfFilesData> data;
  dynamic list;

  TauminchildrenPdfFiles({this.message, this.status, this.data, this.list});

  TauminchildrenPdfFiles.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <TauminchildrenPdfFilesData>[];
      json['data'].forEach((v) {
        data.add(new TauminchildrenPdfFilesData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class TauminchildrenPdfFilesData {
  int srNo;
  String campId;
  String pUniqueID;
  String name;
  ...
  TauminchildrenPdfFilesData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
