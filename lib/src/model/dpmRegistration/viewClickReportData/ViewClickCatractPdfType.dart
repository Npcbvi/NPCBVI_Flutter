class ViewClickCatractPdfType {
  String message;
  bool status;
  List<ViewClickCatractPdfTypeData> data;
  dynamic  list;

  ViewClickCatractPdfType({this.message, this.status, this.data, this.list});

  ViewClickCatractPdfType.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <ViewClickCatractPdfTypeData>[];
      json['data'].forEach((v) {
        data.add(new ViewClickCatractPdfTypeData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class ViewClickCatractPdfTypeData {
  String pUniqueID;
  ...
  String operatedAt;
  int pincode;
  dynamic  operationTypeVal;
  dynamic  disVaRightVal;
  dynamic   disVaLeftVal;
  dynamic  disMedicineVal;
  dynamic  immediateComplicationVal;
  String visualAcquityLeft;
  String visualAcquityRight;
  String ocularLeft;
  String ocularRight;
  int operationTypeId;
  dynamic  sphericalLeft;
  dynamic  cylindricalLeft;
  dynamic  axisLeft;
  dynamic   vaLeft;
  dynamic  sphericalLeftVal;
  dynamic  cylindricalLeftVal;
  dynamic  axisLeftVal;
  dynamic  vaLeftVal;
  dynamic  sphericalRight;
  dynamic  sphericalRightVal;
  dynamic  cylindricalRight;
  dynamic  cylindricalRightVal;
  dynamic  disVaRight;
  dynamic  disMedicine;
  dynamic  immediateComplication;
  ...
  dynamic  vaRight;
  dynamic  vaRightVal;
  dynamic  presentVaLeft;
  dynamic  presentVaLeftVal;
  dynamic  presentVaRight;
  dynamic  presentVaRightVal;
  String followUpDate;
  dynamic  followUpPlace;

  ViewClickCatractPdfTypeData(
      {this.pUniqueID,
  ...
  ViewClickCatractPdfTypeData.fromJson(Map<String, dynamic> json) {
