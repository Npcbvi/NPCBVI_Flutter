class GlaucomPDfFile {
  String message;
  bool status;
  List<GlaucomPDfFileData> data;
  dynamic list;

  GlaucomPDfFile({this.message, this.status, this.data, this.list});

  GlaucomPDfFile.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <GlaucomPDfFileData>[];
      json['data'].forEach((v) {
        data.add(new GlaucomPDfFileData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class GlaucomPDfFileData {
  ...
  GlaucomPDfFileData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
