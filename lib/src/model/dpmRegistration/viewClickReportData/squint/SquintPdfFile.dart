class SquintPdfFile {
  ...
  SquintPdfFile({this.message, this.status, this.data, this.list});

  SquintPdfFile.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <SquintPdfFileData>[];
      json['data'].forEach((v) {
        data.add(new SquintPdfFileData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class SquintPdfFileData {
  ...
  SquintPdfFileData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
