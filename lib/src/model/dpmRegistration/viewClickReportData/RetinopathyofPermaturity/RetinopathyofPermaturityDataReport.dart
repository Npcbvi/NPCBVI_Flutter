class RetinopathyofPermaturityDataReport {
  String message;
  bool status;
  List<RetinopathyofPermaturityDataReportData> data;
  dynamic list;

  RetinopathyofPermaturityDataReport({this.message, this.status, this.data, this.list});

  RetinopathyofPermaturityDataReport.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <RetinopathyofPermaturityDataReportData>[];
      json['data'].forEach((v) {
        data.add(new RetinopathyofPermaturityDataReportData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class RetinopathyofPermaturityDataReportData {
  int id;
  String pUniqueID;
  String name;
  String addressLine1;
  ...
  RetinopathyofPermaturityDataReportData(
      {this.id,
        this.pUniqueID,
        this.name,
        this.addressLine1,
  ...
  RetinopathyofPermaturityDataReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
