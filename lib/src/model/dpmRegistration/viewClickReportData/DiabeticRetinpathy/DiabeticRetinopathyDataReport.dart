class DiabeticRetinopathyDataReport {
  String message;
  bool status;
  List<DiabeticRetinopathyDataReportData> data;
  dynamic list;

  DiabeticRetinopathyDataReport({this.message, this.status, this.data, this.list});

  DiabeticRetinopathyDataReport.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <DiabeticRetinopathyDataReportData>[];
      json['data'].forEach((v) {
        data.add(new DiabeticRetinopathyDataReportData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class DiabeticRetinopathyDataReportData {
  int id;
  String pUniqueID;
  String name;
  String addressLine1;
  ...
  DiabeticRetinopathyDataReportData(
      {this.id,
        this.pUniqueID,
        this.name,
        this.addressLine1,
  ...
  DiabeticRetinopathyDataReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
