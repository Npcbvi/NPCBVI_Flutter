class DiabeticRatinopathyPdfFile {
  String message;
  bool status;
  List<DiabeticRatinopathyPdfFileData> data;
  dynamic list;

  DiabeticRatinopathyPdfFile({this.message, this.status, this.data, this.list});

  DiabeticRatinopathyPdfFile.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    if (json['data'] != null) {
      data = <DiabeticRatinopathyPdfFileData>[];
      json['data'].forEach((v) {
        data.add(new DiabeticRatinopathyPdfFileData.fromJson(v));
      });
    }
    list = json['list'];
  }
...
class DiabeticRatinopathyPdfFileData {
  int srNo;
  String campId;
  String pUniqueID;
  String name;
  ...
  DiabeticRatinopathyPdfFileData(
      {this.srNo,
        this.campId,
        this.pUniqueID,
        this.name,
  ...
  DiabeticRatinopathyPdfFileData.fromJson(Map<String, dynamic> json) {
    srNo = json['sr_no'];
    campId = json['camp_id'];
