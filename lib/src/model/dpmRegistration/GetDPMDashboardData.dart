class GetDPMDashboardData {
  String message;
  bool status;
  GetDPMDashboardDatas data;
  Null list;

  GetDPMDashboardData({this.message, this.status, this.data, this.list});

  GetDPMDashboardData.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    data = json['data'] != null ? new GetDPMDashboardDatas.fromJson(json['data']) : null;
    list = json['list'];
  }
...
class GetDPMDashboardDatas {
  ...
  GetDPMDashboardDatas.fromJson(Map<String, dynamic> json) {
