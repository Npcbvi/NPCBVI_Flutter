...
class NeHospitalNGOrvicesApproveScreen extends StatefulWidget {
  final String redId;
  final String darpanNumber;


  const NeHospitalNGOrvicesApproveScreen({Key key, this.redId, this.darpanNumber}) : super(key: key);

  @override
  _NeHospitalNGOrvicesApproveScreen createState() =>
      _NeHospitalNGOrvicesApproveScreen();
}

class _NeHospitalNGOrvicesApproveScreen extends State<NeHospitalNGOrvicesApproveScreen> {
  Future<List<DataGetAllNgoService>> _ngoServicesFuture;
  String npcbNo, darpan_nos;
...
// Function to Handle Submit Action
  void _submitAction() async {
    ...
    if (selectedAction == "Approved") {
      applicationStatus = 1;
      darpan_nos = widget.darpanNumber;

      print('@@darpan_newVariables'+darpan_nos);
    } else {
