...
import 'package:mohfw_npcbvi/src/dpmdashboard/newhospitalApproval/NewHospitalDoctorLinkedWithHospitalScreen.dart';
...
class NewHospital_Hospital_linkwithNGO extends StatefulWidget {
  @override
  _NewHospital_Hospital_linkwithNGO createState() => _NewHospital_Hospital_linkwithNGO();
}

class _NewHospital_Hospital_linkwithNGO extends State<NewHospital_Hospital_linkwithNGO> {
  ...
  Future<void> fetchHospitals() async {
    ...
    await ApiController.getHospitalsLinkedWithNGO("01840131001");
    setState(() {
...
class _HospitalListScreenState extends State<HospitalListScreen> {
   Future<List<NewDatahospitaldetailsview>> futureHospitalDetails;

  @override
  void initState() {
    super.initState();
    futureHospitalDetails = ApiController.get_DPM_ViewNewHospitalDetailss(widget.hospitalId);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<NewDatahospitaldetailsview>>(
...
class _HospitalDetailScreenState extends State<HospitalDetailScreen> {
  bool isLoading = true;
  NewDatahospitaldetailsview hospital;
  ...
  Future<void> fetchHospitalDetails() async {
    try {
      ...
      List<NewDatahospitaldetailsview> response =
      await ApiController.get_DPM_ViewNewHospitalDetailss(widget.hRegID);
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NewHospitalDoctorLinkedWithHospitalScreen(
