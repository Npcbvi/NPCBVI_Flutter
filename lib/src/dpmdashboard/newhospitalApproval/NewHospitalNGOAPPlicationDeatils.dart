...
import 'package:mohfw_npcbvi/src/dpmdashboard/newhospitalApproval/NewHospital_Hospital_linkwithNGO.dart';
...
class NewHospitalNGOAPPlicationDeatils extends StatefulWidget {
  final DataNewHospitalNGoAppliDetails data;

  NewHospitalNGOAPPlicationDeatils({ this.data});

  @override
  _NewHospitalNGOAPPlicationDeatils createState() => _NewHospitalNGOAPPlicationDeatils();
}

class _NewHospitalNGOAPPlicationDeatils extends State<NewHospitalNGOAPPlicationDeatils> {
          ...
          children: [
            Table(
              ...
              children: [
                ...
                _buildTableRow("Member Name", widget.data.memberName),
                _buildTableRow("Email", widget.data.emailid),
                _buildTableRow("Mobile", widget.data.mobile.toString()),
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => NewHospital_Hospital_linkwithNGO(),// same screen is using as ngo application
