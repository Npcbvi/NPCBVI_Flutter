...
import 'package:mohfw_npcbvi/src/dpmdashboard/newhospitalApproval/NeHospitalNGOrvicesApproveScreen.dart';
import 'package:mohfw_npcbvi/src/model/dpm_approval_status/NgoAppliations/DoctorlinkHospitals.dart';
import 'package:mohfw_npcbvi/src/utils/AppConstants.dart';
import 'package:mohfw_npcbvi/src/utils/Utils.dart';


class NewHospitalDoctorLinkedWithHospitalScreen extends StatefulWidget {
  final String darpanNo;
  final String userId;
  final String hName; // Add hospital name
  final String hRegID; // Add hospital name

  NewHospitalDoctorLinkedWithHospitalScreen({ this.darpanNo,  this.userId, this.hName,this.hRegID,});

  @override
  _NewHospitalDoctorLinkedWithHospitalScreen createState() => _NewHospitalDoctorLinkedWithHospitalScreen();
}

class _NewHospitalDoctorLinkedWithHospitalScreen extends State<NewHospitalDoctorLinkedWithHospitalScreen> {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              var selectedRedId = doctorList[index].hRegID; // Ensure this property exists

                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => NeHospitalNGOrvicesApproveScreen(
                                    redId: doctor.hRegID,
                                    darpanNumber:doctor.nDarpanNo,// Passing h.RedId
                                  ),
                                ),
                              );
                            },
