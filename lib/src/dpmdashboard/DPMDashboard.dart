...
class _DPMDashboard extends State<DPMDashboard> {
                ...
                /* _buildMenuItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DiseaseCatracReportScreen(),
                      ),
                    );
                  },
                ),*/
                                  ...
                                  children: [
                                    ...
                                    _buildDataCellViewBlue("View", () {
                                      SharedPrefs.storeSharedValues(
                                          AppConstant.npcbNo,
                                          offer.npcbNo
                                              .toString()); // here we are saving NPcbNo and rotate in Api
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            ...
            child: Table(
              ...
              children: [
                _buildTableRow('NPCB No:', offer.npcbNo),
                // in this case npcb_no used as hospitalID// reference kamal
                ...
                children: [
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (ngoApproveRevenuMOU == null ||
                            ngodependOrganbisatioSelectValue == null) {
                          // Show an alert if any dropdown is not selected
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                  "Please select both Organisation Type and Status"),
 ...
 /* void _showDetailDialogMOU(BuildContext context, DataGetDPM_MOUApprove offer) {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                _buildTableRows(
                    'Status:', getStatusText(offer.vstatus.toString())),
                SizedBox(height: 8),
                ...
                _buildDataCellViewBlueForButton(
                  "Action",
                  ngodependOrganbisatioSelectValuessss ==
                          1 // Only show button for "Pending for Renew"
                      ? ElevatedButton(
                          onPressed: () async {
                            ...
                            ApproveMOURenewClick response =
                                await ApiController.get_DPM_MouRenew(
                                    h_Reg_ID, userid);
                            ...
                            if (response != null && response.status) {
                              ...
                              Navigator.of(context).pop(
                                  true); // Return `true` to indicate data change
                            } else {
  ...
  Widget _buildDataCellViewBlueForButton(
      String label, Widget actionWidget, VoidCallback onTap) {
    double screenWidth = MediaQuery.of(context).size.width;
    return GestureDetector(
      onTap: onTap, // Trigger the callback when the cell is clicked
      child: Container(
          ...
          children: [
            ...
            Expanded(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child:
                    actionWidget, // This will now hold a button instead of text
              ),
            ),
          ],
        ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      _buildHeaderCellDiseaseDataSettingUp(
                                          'NGO'),
                                      _buildHeaderCellSrNoDiseaseDataTotal(
                                          'Total'),
                                      _buildHeaderCellDiseaseDataAction(
                                          'Action'),
                                    ],
                                  ),
                                  // Data Rows
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Column(
                      mainAxisSize: MainAxisSize.min, // Ensures it does not take extra space
                      children: [
                        Row(
                          children: [
                            _buildHeaderCellSrNoDiseaseData('S.No.', context),
                ...
                child: FutureBuilder<List<DataGetDPM_ScreeningYear>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (_selectedUser == null ||
                        !list.contains(_selectedUser)) {
                      _selectedUser =
                          list.first; // Set first item as default selection
                    }

                    return Padding(
                      padding: const EdgeInsets.fromLTRB(0, 0, 0.0, 0),
                      child: Container(
                        height: 50, // ✅ Fixed height to match other dropdowns
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border.all(color: Colors.grey, width: 1),
                          borderRadius: BorderRadius.circular(10),
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField2<String>(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: InputBorder.none,
                      contentPadding: EdgeInsets.symmetric(
                          vertical: 10, horizontal: 5), // ✅ Adjusted padding
                    ),
                    buttonStyleData: ButtonStyleData(
                          ...
                          DropdownButtonFormField2<DataGetDPM_ScreeningYear>(
                            ...
                            onChanged: (userc) {
                              setState(() {
                                ...
                                getfyid = userc?.fyid ?? '';
                                print('@@getYearGlucoma--$getYearGlucoma');
                                print('@@getfyidSelected here----$getfyid');
                              });
                            },
                            items: list.map((user) {
                            ...
                            dropdownStyleData: DropdownStyleData(
                              ...
                              // ✅ Dropdown will appear 10px lower
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(10),
                                color: Colors.white,
                              ),
                              ...
                              children: [
                                Expanded(
                                  child:
                                    ...
                                    // ✅ DropdownButtonFormField2 specific additions:
                                    dropdownStyleData: DropdownStyleData(
                                      maxHeight: 300,
                                      width: 300,
                                    ...
                                    buttonStyleData: const ButtonStyleData(
                                      height: 20,
                                      padding: EdgeInsets
                                          .zero, // ⬅️ This removes default left space
                                    ),
                                    iconStyleData: const IconStyleData(
                                      icon: Icon(Icons.arrow_drop_down,
                                          color: Colors.black),
                              ...
                              DropdownButtonFormField2<
                                ...
                                iconStyleData: const IconStyleData(
                                  icon: Icon(Icons.arrow_drop_down,
                                      color: Colors.black),
                                  iconSize:
                                      24, // optional, keep it same everywhere
                                ),
                                style: TextStyle(color: Colors.black),
                                dropdownStyleData: DropdownStyleData(
                                  maxHeight: 300,
                                  width: 300,
                                  offset: const Offset(0, 8),
                                  // This offsets the dropdown by 8 pixels vertically
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(10),
                                    color: Colors.white,
                                  ),
                              ...
                              DropdownButtonFormField2<
                                ...
                                onChanged: (usercn) {
                                  setState(() {
                                    ...
                                    getfyid = usercn?.fyid ?? '';
                                    print(
                                        '@@getYearDiabitic-- $getYearDiabitic');
                                    print(
                                        '@@getfyidSelected here---- $getfyid');
                                  });
                                },
                                items: list.map((user) {
                                  return DropdownMenuItem<
                                ...
                                menuItemStyleData: const MenuItemStyleData(
                                  height: 50,
                                  // ✅ Ensures dropdown menu items have a fixed height
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    return DropdownButtonFormField2<String>(
                      ...
                      buttonStyleData: ButtonStyleData(
                        height: 30, // ✅ Increased height for better appearance
                        width: constraints.maxWidth, // ✅ Responsive width
                      ),
                      dropdownStyleData: DropdownStyleData(
                        maxHeight: 250, // ✅ Same as FutureBuilder dropdown
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: Colors.white,
                        ),
                      ...
                      menuItemStyleData: const MenuItemStyleData(
                        height: 50, // ✅ Uniform menu item height
                        padding: EdgeInsets.symmetric(horizontal: 10),
                      ),
                    );
                  },
                ...
                Container(
                  ...
                  child: FutureBuilder<List<DataBindOrganValuebiggerFive>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // If no data, show message and empty dropdown
                      if (list.isEmpty) {
                        return Padding(
                          padding: const EdgeInsets.fromLTRB(0, 0, 0.0, 0),
                          child: Column(
        ...
        Visibility(
          ...
          child: Column(
            children: [
              ...
              Container(
                margin: const EdgeInsets.fromLTRB(5, 0, 5, 0), // Margin applied
                child: FutureBuilder<List<DataGetDPM_ScreeningYear>>(
                  future: _future,
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                    ...
                    return Padding(
                      ...
                      child: DropdownButtonFormField2<DataGetDPM_ScreeningYear>(
                        ...
                        onChanged: (user) {
                          setState(() {
                            _selectedUser = user;
                            getYearCornealBlindness = user.name;
                            getfyid = user.fyid;
                            print(
                                '@@getYearCornealBlindness-- $getYearCornealBlindness');
                            print('@@getfyidSelected---- $getfyid');
                          });
                        },
                        items: list.map((user) {
                          return DropdownMenuItem<DataGetDPM_ScreeningYear>(
                        ...
                        dropdownStyleData: DropdownStyleData(
                          ...
                          offset:
                              const Offset(0, 8), // Adjust dropdown position
                        ),
                        buttonStyleData: ButtonStyleData(
                          height: 20, // Adjusted for better UI
                        ),
                        iconStyleData: const IconStyleData(
                          icon:
                              Icon(Icons.arrow_drop_down, color: Colors.black),
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    return DropdownButtonFormField2<String>(
                      ...
                      dropdownStyleData: DropdownStyleData(
                        maxHeight: 300,
                        width: 300, // ✅ Same as FutureBuilder dropdown
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: Colors.white,
                        ),
                              ...
                              SizedBox(
                                ...
                                child: DropdownButtonFormField2<
                                  ...
                                  dropdownStyleData: DropdownStyleData(
                                    ...
                                    width: 300,
                                    offset: const Offset(0, 8),
                                    // Adjust the dropdown position here
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      color: Colors.white,
                                    ),
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            /// Wrapping Dropdown in `Row` with `Expanded`
                            Row(
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField<DataBindOrgan>(
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField2<
                            ...
                            onChanged: (selected) {
                              setState(() {
                                _selectBindOrgniasationBiggerFive = selected;
                                bindOrganisationNAme = selected?.oName ?? '';
                                npcbVRSurgery = selected?.npcbNo ?? '';
                              });
                            },
                            items: list.map((item) {
                              return DropdownMenuItem<
...
// Function to handle the selected value
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: SizedBox(
                    width: double.infinity,
                    // Make sure it stretches across the available width
              ...
              Visibility(
                ...
                child: Column(
                  children: [
                    ...
                    FutureBuilder<List<Dpm_application_ngoApplicationsData>>(
                      key: Key(dropDownvalueOrgnbaistaionTypeApplications.toString()),
                      future: ApiController.get_DPM_Applications_NGO_GOV_CHC_HOSPITALS_List(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          List<Dpm_application_ngoApplicationsData> ddata = snapshot.data;
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              /// ✅ Header shown only when data exists
                              Row(
                                children: [
                                  _buildHeaderCellSrNo('S.No.'),
                                  _buildHeaderCell('NGO Darpan No'),
                              ...
                              ...ddata.map((offer) {
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    _buildDataCellViewBlue("View", () {
                                      _showDetailNgoApplicationclickDetail(context, offer);
                                    }),
                                  ],
                                );
                              }).toList(),
  ...
  Widget _buildNGOAPPlicationViewDetailsAttachments(
      String npcbNumber, String darpanNumber) {
    return Container(
      margin: EdgeInsets.fromLTRB(5, 0, 5, 0),
      child: Column(
        children: [
...
// Ngo Dashboard main line number 4991
            ...
            _onViewDetailButtonPressed(context, npcbNumber,
                darpanNumber); // Call function on button click
          }),
        ],
      ),
    );
...
// Ngo Dashboard main line number 4991
            _onViewNewHsopitalButtonPressed(context, npcbNumber,
                darpanNumber); // Call function on button click
          }),
        ],
      ),
  ...
  void _onViewDetailButtonPressed(
      BuildContext context, String npcbNumber, String darpanNumber) async {
    List<DataGet_DPM_NGOApplicationDetails> ngoDetails =
        await fetchAndShowNgoDetails(context, npcbNumber, darpanNumber);
  ...
  Future<List<DataGet_DPM_NGOApplicationDetails>> fetchAndShowNgoDetails(
      BuildContext context, String npcbNumber, String darpanNumber) async {
    try {
      var url =
          ApiConstants.baseUrl + ApiConstants.Get_DPM_NGOApplicationDetails;
      ...
      print(
          "@@get_DPM_NGOApplicationDetails--bodyprint--: ${url + body.toString()}");
      ...
      if (response.statusCode == 200) {
        ...
        final Get_DPM_NGOApplicationDetails ngoResponse =
            Get_DPM_NGOApplicationDetails.fromJson(jsonData);
  ...
  void _onViewNewHsopitalButtonPressed(
      BuildContext context, String npcbNumber, String darpanNumber) async {
    List<DataNewHospitalNGoAppliDetails> ngoDetails =
        await fetchAndShowNewHospitalNGOApplictionDetails(
            context, npcbNumber, darpanNumber);
    ...
    if (ngoDetails.isNotEmpty) {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              NewHospitalNGOAPPlicationDeatils(data: ngoDetails.first),
        ),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<List<DataNewHospitalNGoAppliDetails>>
      fetchAndShowNewHospitalNGOApplictionDetails(
          BuildContext context, String npcbNumber, String darpanNumber) async {
    try {
      ...
      print(
          "@@fetchAndShowNewHospitalNGOApplictionDetails--bodyprint--: ${url + body.toString()}");
      ...
      print(
          "@@fetchAndShowNewHospitalNGOApplictionDetails--Api Response: ${response.data}");
      ...
      if (response.statusCode == 200) {
        ...
        final NewHospitalNGoAppliDetails ngoResponse =
            NewHospitalNGoAppliDetails.fromJson(jsonData);
