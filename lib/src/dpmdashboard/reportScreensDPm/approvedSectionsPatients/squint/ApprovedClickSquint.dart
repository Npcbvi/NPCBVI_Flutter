...
class ApprovedClickSquint extends StatefulWidget {
  @override
  _ApprovedClickSquint createState() => _ApprovedClickSquint();
}

class _ApprovedClickSquint extends State<ApprovedClickSquint> {
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountSquintPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        SquintApproveClickPatientDisease(
