...
import 'SquintPdfFile.dart';


class SquintApproveClickPatientDisease extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  SquintApproveClickPatientDisease({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _SquintApproveClickPatientDisease createState() => _SquintApproveClickPatientDisease();
}

class _SquintApproveClickPatientDisease extends State<SquintApproveClickPatientDisease> {
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<SquintDataReportData>>(
  ...
  Future<List<SquintDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_SquintReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
