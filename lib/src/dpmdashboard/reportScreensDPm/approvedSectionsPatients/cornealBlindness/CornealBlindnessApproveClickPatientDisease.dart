...
class CornealBlindnessApproveClickPatientDisease extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  CornealBlindnessApproveClickPatientDisease({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _CornealBlindnessApproveClickPatientDisease createState() => _CornealBlindnessApproveClickPatientDisease();
}

class _CornealBlindnessApproveClickPatientDisease extends State<CornealBlindnessApproveClickPatientDisease> {
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      'Corneal Blindness data approved by DPM',
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<CornealBlindnessDataReportData>>(
  ...
  Future<List<CornealBlindnessDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.GetDPM_CornealBlindnessReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
  ...
  void _showDetails(BuildContext context,
      CornealBlindnessDataReportData offer) {
    showDialog(
      context: context,
