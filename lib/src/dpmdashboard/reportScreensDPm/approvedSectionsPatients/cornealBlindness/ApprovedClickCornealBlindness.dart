...
class ApprovedClickCornealBlindness extends StatefulWidget {
  @override
  _ApprovedClickCornealBlindness createState() => _ApprovedClickCornealBlindness();
}

class _ApprovedClickCornealBlindness extends State<ApprovedClickCornealBlindness> {
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountCornealBlindnessPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        CornealBlindnessApproveClickPatientDisease(
