...
import 'RetinopathyPrematurityapproveClickPatientDisease.dart';




class ApproveclickRetinopathyPrematurity extends StatefulWidget {
  @override
  _ApproveclickRetinopathyPrematurity createState() => _ApproveclickRetinopathyPrematurity();
}

class _ApproveclickRetinopathyPrematurity extends State<ApproveclickRetinopathyPrematurity> {
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      'Retinopathy of Permaturity Patients Data',
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountRetinopathyPermaturityPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        RetinopathyPrematurityapproveClickPatientDisease(
