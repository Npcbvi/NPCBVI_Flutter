...
class RetinopathyPrematurityapproveClickPatientDisease extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  RetinopathyPrematurityapproveClickPatientDisease({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _RetinopathyPrematurityapproveClickPatientDisease createState() => _RetinopathyPrematurityapproveClickPatientDisease();
}

class _RetinopathyPrematurityapproveClickPatientDisease extends State<RetinopathyPrematurityapproveClickPatientDisease> {
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      'Retinopathy of Permaturity data approved by DPM',
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<RetinopathyofPermaturityDataReportData>>(
  ...
  Future<List<RetinopathyofPermaturityDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_RetinopathyPermaturityReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
  ...
  void _showDetails(BuildContext context,
      RetinopathyofPermaturityDataReportData offer) {
    showDialog(
      context: context,
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        RetinopathyofPermaturityPdfFiles(
