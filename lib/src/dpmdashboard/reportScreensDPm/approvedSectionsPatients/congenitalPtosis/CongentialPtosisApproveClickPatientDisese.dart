...
import 'CongentialPdfFile.dart';



class CongentialPtosisApproveClickPatientDisese extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  CongentialPtosisApproveClickPatientDisese({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _CongentialPtosisApproveClickPatientDisese createState() => _CongentialPtosisApproveClickPatientDisese();
}

class _CongentialPtosisApproveClickPatientDisese extends State<CongentialPtosisApproveClickPatientDisese> {
                ...
                children: [
                  Expanded(
                    ...
                    child: Text(
                      ...
                      'Congenital Ptosis data approved by DPM',
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<CongentialPtosisDataReportData>>(
  ...
  Future<List<CongentialPtosisDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_CongenitalReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
  ...
  void _showDetails(BuildContext context,
      CongentialPtosisDataReportData offer) {
    showDialog(
      context: context,
