...
import 'CongentialPtosisApproveClickPatientDisese.dart';


class ApprovedClickCongentialPtosis extends StatefulWidget {
  @override
  _ApprovedClickCongentialPtosis createState() => _ApprovedClickCongentialPtosis();
}

class _ApprovedClickCongentialPtosis extends State<ApprovedClickCongentialPtosis> {
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      'Congenital Ptosis Patients Data',
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountCongenitalPtosisPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        CongentialPtosisApproveClickPatientDisese(
