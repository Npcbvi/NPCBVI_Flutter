...
import 'DiabeticRatiopathyApproveClickPatientDisease.dart';



class ApprovedClickdiabeticRetinopathy extends StatefulWidget {
  @override
  _ApprovedClickdiabeticRetinopathy createState() => _ApprovedClickdiabeticRetinopathy();
}

class _ApprovedClickdiabeticRetinopathy extends State<ApprovedClickdiabeticRetinopathy> {
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountDiabeticPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DiabeticRatiopathyApproveClickPatientDisease(
