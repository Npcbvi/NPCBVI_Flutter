...
import 'DiaebticRetinopatrhyPdfFile.dart';




class DiabeticRatiopathyApproveClickPatientDisease extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  DiabeticRatiopathyApproveClickPatientDisease({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _DiabeticRatiopathyApproveClickPatientDisease createState() => _DiabeticRatiopathyApproveClickPatientDisease();
}

class _DiabeticRatiopathyApproveClickPatientDisease extends State<DiabeticRatiopathyApproveClickPatientDisease> {
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<DiabeticRetinopathyDataReportData>>(
  ...
  Future<List<DiabeticRetinopathyDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_DiabeticlReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
  ...
  void _showDetails(BuildContext context,
      DiabeticRetinopathyDataReportData offer) {
    showDialog(
      context: context,
