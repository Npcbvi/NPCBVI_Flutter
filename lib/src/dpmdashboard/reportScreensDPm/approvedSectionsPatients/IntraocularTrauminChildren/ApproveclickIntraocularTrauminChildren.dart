...
import 'IntraocularTrauminchildrenPatientDisease.dart';


class ApproveclickIntraocularTrauminChildren extends StatefulWidget {
  @override
  _ApproveclickIntraocularTrauminChildren createState() => _ApproveclickIntraocularTrauminChildren();
}

class _ApproveclickIntraocularTrauminChildren extends State<ApproveclickIntraocularTrauminChildren> {
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountTraumaPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
  ...
  void _showReportDataDisplay(BuildContext context,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            'Trauma in Children Patients Data',
            style: TextStyle(
              fontWeight: FontWeight.bold,
              color: Colors.blue,
            ),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        IntraocularTrauminchildrenPatientDisease(
