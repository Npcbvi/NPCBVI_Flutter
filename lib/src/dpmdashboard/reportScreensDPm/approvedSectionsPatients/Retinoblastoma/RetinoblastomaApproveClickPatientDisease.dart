...
import 'package:mohfw_npcbvi/src/dpmdashboard/reportScreensDPm/approvedSectionsPatients/Retinoblastoma/RetinoblastomaPdfFiles.dart';
...
class RetinoblastomaApproveClickPatientDisease extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  RetinoblastomaApproveClickPatientDisease({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _RetinoblastomaApproveClickPatientDisease createState() => _RetinoblastomaApproveClickPatientDisease();
}

class _RetinoblastomaApproveClickPatientDisease extends State<RetinoblastomaApproveClickPatientDisease> {
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      'Retinoblastoma  data approved by DPM',
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<RetinoBlastmaDataReportData>>(
  ...
  Future<List<RetinoBlastmaDataReportData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_RetinoblastomaReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
  ...
  void _showDetails(BuildContext context,
      RetinoBlastmaDataReportData offer) {
    showDialog(
      context: context,
