...
import 'package:mohfw_npcbvi/src/dpmdashboard/reportScreensDPm/approvedSectionsPatients/Retinoblastoma/RetinoblastomaApproveClickPatientDisease.dart';
...
import 'package:mohfw_npcbvi/src/dpmdashboard/reportScreensDPm/approvedSectionsPatients/cornealBlindness/CornealBlindnessApproveClickPatientDisease.dart';
import 'package:mohfw_npcbvi/src/dpmdashboard/reportScreensDPm/approvedSectionsPatients/squint/SquintApproveClickPatientDisease.dart';
...
class ApproveClickRetinoblastoma extends StatefulWidget {
  @override
  _ApproveClickRetinoblastoma createState() => _ApproveClickRetinoblastoma();
}

class _ApproveClickRetinoblastoma extends State<ApproveClickRetinoblastoma> {
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountRetinoblastomaPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        RetinoblastomaApproveClickPatientDisease(
