...
import 'package:mohfw_npcbvi/src/dpmdashboard/reportScreensDPm/approvedSectionsPatients/glaucoma/ViewClickGalucomadataApproval.dart';
...
class GlaucomaApproveClickPatientDiseaseInnnerDisplayData extends StatefulWidget {
  @override
  _GlaucomaApproveClickPatientDiseaseInnnerDisplayData createState() => _GlaucomaApproveClickPatientDiseaseInnnerDisplayData();
}

class _GlaucomaApproveClickPatientDiseaseInnnerDisplayData extends State<GlaucomaApproveClickPatientDiseaseInnnerDisplayData> {
  ...
  String _chosenValuechnagesONSelection="Glaucoma";
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    flex: 2,
                    child: Text(
                      '${_chosenValuechnagesONSelection} Data Report',
                ...
                Column(
                  children: [
                    FutureBuilder<List<DataReportScreen>>(
                      future: ApiController.getData_amount_totalCountGlaucomaPatients(int.parse(getfyidNgoHospital),"","",state_code_login,district_code_login, dropDownvalueOrgnbaistaionType.toString(),bindOrganisationNAme, statusTypeValueShow.toString(),getYearNgoHopital,npcbNo),
