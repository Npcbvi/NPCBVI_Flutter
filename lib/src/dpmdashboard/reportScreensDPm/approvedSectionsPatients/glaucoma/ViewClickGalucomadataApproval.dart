...
import 'package:mohfw_npcbvi/src/model/dpmRegistration/viewClickReportData/galucoma/galucomaDataReporty.dart';
...
import 'GlaucomatPdfViewClick.dart';


class ViewClickGalucomadataApproval extends StatefulWidget {
  final String ngoName;
  final String orgNAme;
  final String npcbNo;

  ViewClickGalucomadataApproval({ this.ngoName,this.orgNAme,this.npcbNo});
  @override
  _ViewClickGalucomadataApproval createState() => _ViewClickGalucomadataApproval();
}

class _ViewClickGalucomadataApproval extends State<ViewClickGalucomadataApproval> {
  ...
  Widget reportviewCataract() {
    return FutureBuilder<List<galucomaDataReportyData>>(
  ...
  Future<List<galucomaDataReportyData>> _loadCataractReport() async {
    try {
      ...
      return await ApiController.getDPM_GlaucomaReport(
        int.parse(fyId),
        "",
        "",
        state_code_login,
            ...
            child: Table(
              ...
              children: [
               ...
               // _buildTableRow('Operation Date:', Utils.formatDateString(offer.operatedOn.toString())),
                ...
                _buildTableRow('Operated On:', Utils.formatDateString(offer.operatedOn.toString())),
